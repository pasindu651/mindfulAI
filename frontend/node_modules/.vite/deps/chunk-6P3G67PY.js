import {
  OverlayService
} from "./chunk-VJSJO5HJ.js";
import {
  CSSTransition
} from "./chunk-BGUKH7JE.js";
import {
  SpinnerIcon
} from "./chunk-WXGOL4UC.js";
import {
  Ripple
} from "./chunk-YWIS7G7G.js";
import {
  IconBase
...
var Dropdown = React7.memo(React7.forwardRef(function(inProps, ref) {
  ...
  var _React$useState = React7.useState(""), _React$useState2 = _slicedToArray2(_React$useState, 2), filterState = _React$useState2[0], setFilterState = _React$useState2[1];
  var _React$useState3 = React7.useState(false), _React$useState4 = _slicedToArray2(_React$useState3, 2), focusedState = _React$useState4[0], setFocusedState = _React$useState4[1];
  var _React$useState5 = React7.useState(-1), _React$useState6 = _slicedToArray2(_React$useState5, 2), focusedOptionIndex = _React$useState6[0], setFocusedOptionIndex = _React$useState6[1];
  var _React$useState7 = React7.useState(false), _React$useState8 = _slicedToArray2(_React$useState7, 2), overlayVisibleState = _React$useState8[0], setOverlayVisibleState = _React$useState8[1];
...
//# sourceMappingURL=chunk-6P3G67PY.js.map
